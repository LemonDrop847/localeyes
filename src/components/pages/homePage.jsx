          ...
          <div className="table-cell">
            <ul className="leader">
              <li>
                ...
                <h2>
                  Potholes<span className="number">9,735</span>
                </h2>
              </li>
              <li>
                ...
                <h2>
                  Increasing Robbery<span className="number">8,364</span>
                </h2>
              </li>
              <li>
                ...
                <h2>
                  ...
                  <span className="number">7,621</span>
                </h2>
              </li>
              <li>
                ...
                <h2>
                  Leaking pipes<span className="number">4,582</span>
                </h2>
              </li>
            </ul>
          </div>
